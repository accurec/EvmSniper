...
class EmvSniperTest < Minitest::Test
  ...
  def test_check_eth_evm_sniper_get_sender_from_transaction_hash
    @eth_evm_sniper = EvmSniper.new(ConfigManager.new(Enums::Network::ETH), true, Enums::ListenerMode::TRANSFER)
    @eth_evm_sniper.get_sender_from_transaction_hash('0x409f47d6d27761a12891a1417107be3e333c38c97fd2bc5798a9888f943e5ef4')
  end
end